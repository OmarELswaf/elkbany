...
const usages = [
  'ظمط مولول الاسطح قبل اعمال العزل المائي',
...
const LightweightConcrete = () => {
  return (
    <section id="lightweight-concrete" className="paper-texture py-20 md:py-32 relative overflow-hidden">
      ...
      <div className="container-custom relative z-10">
        ...
        >
          <img
            src="https://images.unsplash.com/photo-1504917595217-340fc7fd7e18?w=1200&q=80"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          {/* Right column - Installation Method */}
          <motion.div
            initial={{ opacity: 0, x: 40 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
          ...
          >
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
              className="bg-light-gray/50 rounded-lg p-6 border-r-4 border-primary-red"
            >
              <p className="text-dark font-cairo leading-relaxed">
        ...
        >
          <img
            src="https://images.unsplash.com/photo-1581092917056-0c4c3acd3789?w=1200&q=80"
            alt="Lightweight concrete installation"
